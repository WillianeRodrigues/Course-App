...
import br.com.usp.willianerodrigues.course.database.DbController;
...
public class CourseApplication extends Application {
    ...
    public Usuario buscarUsername(String username) {
        return controller.buscarUsuarioPor("usuario", username);
    }

    public Usuario buscarUserActive() {
        return controller.buscarUsuarioAtivo();
    }
